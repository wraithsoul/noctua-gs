...
killsay = {} do
    ...
    killsay.multi_phrases_kill = {
        ...
        {
            "noctua gave me a chance to deport those angels back to hell"
        },
        {
        ...
        {
            "разъебу вас в шахматы писать сюда @rapidfloodx"
        },
        {
        ...
        {
            "словил так называемай храп хррррр"
        },
        {
    ...
    killsay.multi_phrases_death = {
        ...
        {
            "чел опять мануалом фулл опен встал"
        },
        {
            "чел забайтился непонятно на что"
        },
        {
            "ты че найух",
            "текла ебаная анухй",
            "сколько тебе еще раз повезет",
            "ебаный даун без башки",
            "на плечах"
        },
        {
            "ЛЕТИ СЫН ШЛЮХИ ЕБАНОЙ"
        },
        {
